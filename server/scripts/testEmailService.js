...
async function testEmailService() {
  ...
  testEmails.forEach((email) => {
    ...
    if (validation.isValid) {
      ...
      console.log(
        `   Professionnel: ${validation.isProfessional ? "Oui" : "Non"}`
      );
    }
  });
  ...
  console.log(
    `👤 Nom d'affichage: ${EmailUtils.generateDisplayName(testEmail)}`
  );
  ...
  console.log("\n✅ === Tests terminés ===");
  console.log(
    "💡 Pour tester l'envoi réel d'emails, configurez vos variables SMTP dans .env"
  );
}
