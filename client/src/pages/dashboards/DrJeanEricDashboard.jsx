...
const DOCTOR_ID = 'dr-jean-eric-panacciulli';
const DOCTOR_NAME = getDoctorDisplayName(DOCTOR_ID);

export default function DrJeanEricDashboard() {
            ...
            {currentPatient ? (
              ...
              <div className="bg-gray-50 rounded-lg p-4 text-center">
                ...
                <button
                  ...
                  className="mt-3 bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 transition disabled:bg-gray-400"
                >
                  👋 Appeler le suivant
                </button>
              </div>
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          {index === 0 && (
                            <span className="inline-block bg-purple-500 text-white px-2 py-1 rounded text-xs font-bold mt-1">
                              ⬅️ SUIVANT
                            </span>
                          )}
                        </div>
