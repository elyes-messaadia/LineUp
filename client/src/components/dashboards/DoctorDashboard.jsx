...
export default function DoctorDashboard() {
  ...
  const stats = {
    ...
    nextAppointment: todayAppointments.find(
      ...
      {selectedView === "overview" && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {stats.nextAppointment && (
            <div
              className="lg:col-span-2 bg-gradient-to-br from-primary-500 to-primary-600 
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-primary-100">
                    ...
                    {stats.nextAppointment.duration} min)
                  </span>
                  <span
              ...
              {todayAppointments.length > 0 ? (
                ...
                <div className="p-12 text-center">
                  <Icon
                    name="calendar"
                    size="xl"
                    className="text-secondary-300 mb-4 mx-auto"
                  />
                  <p className="text-secondary-600">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <SecondaryButton size="sm" icon="info" className="mt-2">
                      Dossier
                    </SecondaryButton>
                  </div>
                </div>
