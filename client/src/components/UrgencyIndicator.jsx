...
const UrgencyIndicator = ({ 
  ...
  return (
    <div className={`${config.bgColor} ${config.borderColor} border rounded-lg ${sizeClasses.container}`}>
        ...
        <div className="flex-1">
          ...
          {showDetails && (
            <div className="mt-2 space-y-1">
              <p className={`${config.textColor} ${sizeClasses.subtitle} font-medium`}>
                {config.action}
              </p>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div className="flex-1 bg-gray-200 rounded-full h-2">
                        <div 
                          ...
                          style={{ 
                            width: `${Math.round(urgencyAssessment.confidenceScore * 100)}%` 
                          }}
                        />
                      </div>
